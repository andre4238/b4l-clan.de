<?php /* Smarty version Smarty3rc4, created on 2020-10-25 21:20:42
         compiled from "/var/www/html/ts3wi/templates/new/sgroupeditperm.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19480288435f95de1a7da106-55278639%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c9df8a54f905e1b417df636fc8d712e79ccad8a4' => 
    array (
      0 => '/var/www/html/ts3wi/templates/new/sgroupeditperm.tpl',
      1 => 1362142980,
    ),
  ),
  'nocache_hash' => '19480288435f95de1a7da106-55278639',
  'function' => 
  array (
  ),
...
<table  class="border" cellpadding="0" cellspacing="0" style="width:100%">
	...
	<tr>
		...
		<form method="post" action="index.php?site=sgroupeditperm&amp;sgid=<?php echo $_smarty_tpl->getVariable('sgid')->value;?>
...
<table  class="border" cellpadding="0" cellspacing="0" style="width:100%">
	<tr>
		<td class="thead" colspan="8">(<?php echo $_smarty_tpl->getVariable('sgid')->value;?>
) <?php echo $_smarty_tpl->getVariable('sgroupname')->value;?>
 <?php echo $_smarty_tpl->getVariable('lang')->value['permissionlist'];?>
</td>
	</tr>
	<tr>
		<td class="thead" style="width:55px">&nbsp;<a href="javascript:Klappen(0)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
.png" id="Pic0" name="<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
" border="0" alt="aus/ein-klappen" /></a></td>
		<td class="thead" style="width:55px"><?php echo $_smarty_tpl->getVariable('lang')->value['permid'];?>
</td>
		<td class="thead" style="width:370px"><?php echo $_smarty_tpl->getVariable('lang')->value['permname'];?>
</td>
		<td class="thead" style="width:58px"><?php echo $_smarty_tpl->getVariable('lang')->value['value'];?>
</td>
		<td class="thead" style="width:58px"><?php echo $_smarty_tpl->getVariable('lang')->value['skip'];?>
</td>
		<td class="thead" style="width:58px"><?php echo $_smarty_tpl->getVariable('lang')->value['negated'];?>
</td>
		<td class="thead" style="width:98px"><?php echo $_smarty_tpl->getVariable('lang')->value['options'];?>
</td>
		<td class="thead" style="width:98px"><?php echo $_smarty_tpl->getVariable('lang')->value['grant'];?>
...
" id="Lay1">
				<table style="width:100%;border-collapse:collapse;" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td class='subcat' colspan="7">&nbsp;<a href="javascript:Klappen(2)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay2">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==2){?>
				...
				<tr>
					<td class='subcat'>&nbsp;</td>
					<td class='subcat' colspan="7">&nbsp;<a href="javascript:Klappen(3)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay3">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==3){?>
				...
				<tr>
					<td class='subcat'>&nbsp;</td>
					<td class='subcat' colspan="7">&nbsp;<a href="javascript:Klappen(4)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay4">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==4){?>
				...
				<tr>
					<td class='subcat'>&nbsp;</td>
					<td class='subcat' colspan="7">&nbsp;<a href="javascript:Klappen(5)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay5">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==5){?>
			...
			<tr>
				<td class='maincat left' colspan="8">&nbsp;<a href="javascript:Klappen(6)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay6">
				<table style="width:100%;border-collapse:collapse;" cellpadding="0" cellspacing="0">
					<tr>
						<td class='subcat' style='width:60px'>&nbsp;</td>
						<td class='subcat' colspan="7">&nbsp;<a href="javascript:Klappen(7)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay7">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==7){?>
					...
					<tr>
						<td class='subcat'>&nbsp;</td>
						<td class='subcat' colspan="7">&nbsp;<a href="javascript:Klappen(8)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay8">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==8){?>
					...
					<tr>
						<td class='subcat'>&nbsp;</td>
						<td class='subcat' colspan="7">&nbsp;<a href="javascript:Klappen(9)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay9">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==9){?>
			...
			<tr>
				<td class='maincat left' colspan="8">&nbsp;<a href="javascript:Klappen(10)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay10">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==10){?>
					<tr>
						...
						<td class='subcat' colspan="7">&nbsp;<a href="javascript:Klappen(11)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay11">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==11){?>
					...
					<tr>
						<td class='subcat'>&nbsp;</td>
						<td class='subcat' colspan="7">&nbsp;<a href="javascript:Klappen(12)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay12">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==12){?>
					...
					<tr>
						<td class='subcat'>&nbsp;</td>
						<td class='subcat' colspan="7">&nbsp;<a href="javascript:Klappen(13)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay13">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==13){?>
					...
					<tr>
						<td class='subcat'>&nbsp;</td>
						<td class='subcat' colspan="7">&nbsp;<a href="javascript:Klappen(14)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay14">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==14){?>
					...
					<tr>
						<td class='subcat'>&nbsp;</td>
						<td class='subcat' colspan="7">&nbsp;<a href="javascript:Klappen(15)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay15">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==15){?>
			...
			<tr class='maincat left'>
				<td colspan="8">&nbsp;<a href="javascript:Klappen(16)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay16">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==16){?>
					<tr>
						<td class='subcat' style='width:51px'>&nbsp;</td>
						<td class='subcat' colspan="7">&nbsp;<a href="javascript:Klappen(17)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay17">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==17){?>
					...
					<tr>
						<td class='subcat'>&nbsp;</td>
						<td class='subcat' colspan="7">&nbsp;<a href="javascript:Klappen(18)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay18">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==18){?>
					...
					<tr>
						<td class='subcat'>&nbsp;</td>
						<td class='subcat' colspan="7">&nbsp;<a href="javascript:Klappen(19)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay19">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==19){?>
					...
					<tr>
						 <td class='subcat'>&nbsp;</td>
						 <td class='subcat' colspan="7">&nbsp;<a href="javascript:Klappen(20)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay20">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==20){?>
			...
			<tr class='maincat left'>
				<td colspan="8">&nbsp;<a href="javascript:Klappen(21)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay21">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==21){?>
					<tr>
						<td class='subcat' style='width:51px'>&nbsp;</td>
						<td class='subcat' colspan="7">&nbsp;<a href="javascript:Klappen(22)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay22">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==22){?>
					...
					<tr>
						 <td class='subcat'>&nbsp;</td>
						 <td class='subcat' colspan="7">&nbsp;<a href="javascript:Klappen(23)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay23">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==23){?>
					...
					<tr>
						<td class='subcat'>&nbsp;</td>
						<td class='subcat' colspan="7">&nbsp;<a href="javascript:Klappen(24)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay24">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==24){?>
					...
					<tr>
						<td class='subcat'>&nbsp;</td>
						<td class='subcat' colspan="7">&nbsp;<a href="javascript:Klappen(25)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
" id="Lay25">
		...
		<?php if ($_smarty_tpl->tpl_vars['key']->value==25){?>
			...
			<tr class='maincat left'>
				<td colspan="8">&nbsp;<a href="javascript:Klappen(26)"><img src="gfx/images/<?php echo $_smarty_tpl->getVariable('disp_pic')->value;?>
...
');"><?php echo $_smarty_tpl->getVariable('lang')->value['set'];?>
 ...
 center" style="width:58px">
					...
					<td class="<?php echo $_smarty_tpl->getVariable('td_col')->value;?>
 center" style="width:58px">
					<input type='checkbox' <?php if ($_smarty_tpl->tpl_vars['value2']->value['permnegated']==1){?>checked="checked"<?php }?> name="perm[<?php echo $_smarty_tpl->tpl_vars['value2']->value['permid'];?>
][negated]" value="1" />
					</td>
					<td class="<?php echo $_smarty_tpl->getVariable('td_col')->value;?>
" style="width:100px">
